...
@section('page_header')
    <div class="container-fluid">
        ...
        @can('edit', app($dataType->model_name))
            ...
            @endif
        @endcan
        <label for="excel" class="btn btn-primary">
            <form action="{{ route('excel.import') }}" id="importExcel" method="POST">
                @csrf
                    <i class="voyager-list"></i>
                    <span>Importar Planilha</span>
                <input type="file" id="excel" name="excel" style="display:none" onchange="document.importExcel.submit();">
            </form>
        </label>
